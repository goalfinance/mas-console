<div data-dojo-type="dijit/form/Form" data-dojo-id="authnet.viewForm" id="authnet.viewForm">
	<div class="instructionBox">Please update the information of the new authorized network.</div>
	<table id="tableAddForm">
		<tr>
			<td><label for="authNetId">Authorized Network ID:</label></td>
			<td><input data-dojo-id="authnet.view.authNetId" type="text" name="authNetId" data-dojo-type="dijit/form/ValidationTextBox"
						required="true"
						regExp="^[0-9]{8}$"
		...
		<tr>
			...
			<td><input type="text" name="name" data-dojo-id="authnet.view.name" data-dojo-type="dijit/form/ValidationTextBox"
						required="true"
		...
		<tr>
			...
			<td>
				<div name="authNetType" data-dojo-id="authnet.view.authNetType" data-dojo-type="dijit/form/Select" data-dojo-props="value:'0'">
		...
		<tr>
			...
			<td><input type="text" name="acquirerId" data-dojo-id="authnet.view.acquirerId" data-dojo-type="dijit/form/ValidationTextBox"
			maxLength="20"/></td>
		</tr>

		<tr>
			<td><label for="issuerId">Issuer ID:</label></td>
			<td><input type="text" name="issuerId" data-dojo-id="authnet.view.issuerId" data-dojo-type="dijit/form/ValidationTextBox"
			maxLength="20"/></td>
		</tr>
		<tr>
			<td>
				<div data-dojo-type="dijit/form/CheckBox" data-dojo-id="authnet.view.openFlag" name="openFlag" checked=false value="true">
		...
		<tr>
			...
			<td>
				<div name="networkStatus" data-dojo-id="authnet.view.networkStatus" data-dojo-type="dijit/form/Select" data-dojo-props="value:'O'">
	...
	<div class="dijitDialogPaneActionBar">
		...
		<div class="right-side">
			<button data-dojo-type="dijit/form/Button">update
