<div data-dojo-type="dojo/store/JsonRest"
	...
	data-dojo-props="target:'dojo/security/maintaining/role/maintain/active', idProperty:'sid'">
</div>

<div data-dojo-type="dojo/store/JsonRest"
	data-dojo-id="security.maintaining.role.RoleJsonStore"
	data-dojo-props="target:'dojo/security/maintaining/role/maintain', idProperty:'sid'">
</div>
...
<div data-dojo-type="dojo/store/JsonRest"
	...
	data-dojo-props="target:'dojo/security/maintaining/permission/role', idProperty:'sid'">
</div>
...
<div data-dojo-type="dijit/Dialog"
	...
	data-dojo-props="title:'Add Role', href:'dojo/security/maintaining/role/show_add_form'">
</div>
	...
	<div data-dojo-type="dijit/layout/ContentPane"
		...
		<div data-dojo-type="dojox.grid.EnhancedGrid"
			...
			data-dojo-props="store:security.maintaining.role.RoleStore, noDataMessage:'no role defined...',
					...
					structure:[
						{field:'roleName', name:'Role Name', datatype:'string', width:'80%'},
						{field:'createTime', name:'Create Time', datatype:'date', width:'20%'}
					]"
		...
		<button data-dojo-type="dijit/form/Button" name="EditRoleButton">
			...
			<script type="dojo/on" data-dojo-event="click">
				...
				security.maintaining.role.dialogViewForm.set("href", "dojo/security/maintaining/role/show_view_form/?sId=" + sid);
		...
		<button data-dojo-type="dijit/form/Button" name="addPermissionButton">
			...
			<script type="dojo/on" data-dojo-event="click">
				...
				dojo.array.forEach(selectedItems, function(selectedItem){
					...
					security.maintaining.role.dialogResSelection.set("href", "dojo/security/maintaining/resource/show_resource_selection_view?roleSid=" + sid)
