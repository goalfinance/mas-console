...
<body class="claro">
	...
	<script type="dojo/require">
	  ...
	  "dojox.grid.enhanced.plugins.Printer": "dojox/grid/enhanced/plugins/Printer",
	...
	<script type="text/javascript">
		function showSrvErrmsg(error) {
			...
			frameui.srvsideErrmsgDialog.set("href",
					"dojo/commons/show_error_message?errmsg=" + error["responseText"]);
	...
	<div data-dojo-type="dijit/layout/BorderContainer" id="mainContainer"
		...
		<div data-dojo-type="dijit/layout/ContentPane" id="headerPane"
				data-dojo-props="splitter:false, region:'top', href:'dojo/security/show_login'">
		</div>		
		<div data-dojo-type="dijit/layout/AccordionContainer"
			...
			<c:choose>
				<c:when test="${groups.size() <= 0}">
					...
					data-dojo-props="title: 'No Content', href:'dojo/security/show_resources/9999'"
					class="paneAccordion"></div>
				</c:when>
				<c:otherwise>
					<c:forEach items="${groups}" var="group">
						<div data-dojo-type="dijit/layout/AccordionPane" id="${group.gid}"
							data-dojo-props="title: '${group.name}', href:'dojo/security/show_resources/${group.gid}'"
							class="paneAccordion"></div>
					</c:forEach>
				</c:otherwise>
			</c:choose>
