...
<div data-dojo-type="dijit/Dialog"
	...
	data-dojo-props="title:'Add security user',
					href:'dojo/security/maintaining/user/show_add_form'">
</div>
		...
		<div data-dojo-type="dijit/form/Button">
			...
			try{
				...
				dojo.array.forEach(selectedItems, function(selectedItem){
					...
					security.maintaining.user.dialogViewForm.set("href", "dojo/security/maintaining/user/show_view_form?sId=" + sid);
