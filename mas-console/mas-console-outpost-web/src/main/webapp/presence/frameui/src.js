require([
	...
	lang.setObject("frame.basename", function(path, suffix) {
	...
	lang.setObject("frame.addTab", function(tabContainer, href, title, closable){
	...
	lang.setObject("frame.formatterIcon", function(iconClass){
